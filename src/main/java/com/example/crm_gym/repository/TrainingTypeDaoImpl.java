...
public class TrainingTypeDaoImpl implements TrainingTypeDAO {
    ...
    public Optional<TrainingType> findByName(String name) {
        try {
            TrainingTypeName trainingTypeName = TrainingTypeName.fromString(name);
            ...
            throw new IllegalArgumentException("Invalid TrainingTypeName: " + name, e);
        } catch (Exception e) {
            throw new RuntimeException("Error while fetching TrainingType by name: " + name, e);
        }
    }
